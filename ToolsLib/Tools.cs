...
namespace ToolsLib
{
    public static class Tools
    {
        ...
        public static class SpeedTest
        {
            ...
            /// <summary>
            /// Останавливает и сбрасывает тайтер.
            /// </summary>
        ...
        {
            string[] arrFirstName = { "Иванов", "Петров", "Сидоров", "Пупкин", "Ложников",
                "Вилкин", "Новоселов", "Захаров", "Щукин", "Дорохов" };
            string[] arrLastName = { "Сергей", "Виталий", "Иван", "Николай", "Алексей",
                "Александр", "Михаил", "Владимир", "Светозар", "Артём" };

            switch (x)
            {
                case 1:
                    return arrFirstName[RandomR.r.Next(0, 9)];                    
                case 2:
                    return arrLastName[RandomR.r.Next(0, 9)];                    
                default:
                    return "Ошибка ввода";
            }
        }
